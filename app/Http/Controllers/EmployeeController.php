...
class EmployeeController extends Controller
{
    ...
    function store(Request $req){
        ...
        //return $req->input();
        $is_employee = Employee::where('email', $req->email)->first();
    ...
    function show(Request $req){
        $employee = Employee::with('empDetails')->get();
       
        return view("admin.employeeList",compact('employee'));
    }

    function active($id){
        $status = Employee::where('id',$id)->update([
            "status" => 1
        ]);
    ...
    function delete($id){
        $status = Employee::where('id',$id)->delete();
    ...
    function employeeProfile(Request $req){
        $employee =  Employee::where('email',session('user'))->with(['empDetails','empContacts'])->get();
    ...
    function update(Request $req){
        ...
        $data = Employee::with(['empDetails','empContacts'])->find($req->emp_id);
